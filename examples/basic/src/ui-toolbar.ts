import {Toolbar, Button} from '@cliui/elements';
...
style.textContent = `
  toolbar { border-style: single; border-color: #475569; padding: 0 1; }
`;
...
const tb1 = document.createElement('toolbar');
...
const tb2 = document.createElement('toolbar');
