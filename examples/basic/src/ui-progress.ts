import {Progress, Button} from '@cliui/elements';
import {createDemo, createShell, createSection, createStatus} from './_helpers.ts';

const {terminal, document, window} = createDemo();
window.customElements.define(Progress.tagName, Progress);
...
const bar3 = document.createElement('progress');
...
const bar4 = document.createElement('progress');
